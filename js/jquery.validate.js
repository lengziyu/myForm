...
function(a) {
    ...
    a.extend(a.validator, {
        ...
        messages: {
            ...
            number: "请输入有效的手机号码哦",
            telNumber:"请输入有效的座机号码哦",
            digits: "请输入数字",
            creditcard: "请输入有效的信用卡号码",
            equalTo: "两次输入的密码不一致",
            maxlength: a.validator.format("请输入的数值不能多于{0}位数"),
            minlength: a.validator.format("请输入的数值不能少于{0}位数"),
            rangelength: a.validator.format("请输入的数值在{0}至{1}位之间"),
            range: a.validator.format("请输入一个值在{0}至{1}之间"),
        ...
        prototype: {
            ...
            hideErrors: function() {
                ...
                $("span.error").parent().addClass('werror');
            },
            hideThese: function(a) {
                a.not(this.containers).text(""),
                this.addWrapper(a).addClass("success")
            },
            valid: function() {
                return 0 === this.size()
            },
        ...
        methods: {
            ...
            number: function(a, b) {
                return this.optional(b) || /^(13[0-9]|14[5|7]|15[0|1|2|3|5|6|7|8|9]|17[0|6|7|8]|18[0|1|2|3|5|6|7|8|9])\d{8}$/.test(a)
            },
            telNumber: function(a, b) {
                return this.optional(b) || /^((\d{3,4}-)|\d{3.4}-)?\d{7,8}$/.test(a)
            },
            digits: function(a, b) {
